create table if not exists public.leaderboard_scores (
  ...
  difficulty text not null check ((difficulty in ('easy', 'medium', 'hard', 'alin') or difficulty ~ '^(diagonal|thermo|killer)_(easy|medium|hard)(_alin)?$')),
...
alter table public.leaderboard_scores
  add constraint leaderboard_scores_difficulty_check check ((difficulty in ('easy', 'medium', 'hard', 'alin') or difficulty ~ '^(diagonal|thermo|killer)_(easy|medium|hard)(_alin)?$'));
