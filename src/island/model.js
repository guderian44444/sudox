...
import { attractionVisitorIds } from "./attractions.js?v=v60";
import { constructionTeamRate } from "./companions.js?v=v60";
import { axialDistance, axialKey, axialNeighbors, footprintCells, hexRange, parseAxialKey } from "./hex.js?v=v60";
