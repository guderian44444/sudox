import { BUILDING_CATALOG, ITEM_CATALOG, RECIPE_CATALOG } from "./catalog.js?v=v61";
import { activeVehicleCount, availableInventoryQuantity, scheduleProcessingInputBatches } from "./model.js?v=v61";
